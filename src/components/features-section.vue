      ...
      <div class="features-inner section-inner">
        <div class="features-header text-center">
          <div class="container-sm">
            <h2 class="section-title mt-0">Meet Dereva</h2>
            <p class="section-paragraph">Dereva makes fleet management easy and efficient with these powerful features.</p>
          </div>
        </div>
        <div class="features-wrap">
          <div class="feature text-center">
            <div class="feature-inner">
              ...
              <h4 class="feature-title h3-mobile mb-8">Driver Tracking</h4>
              <p class="text-sm">Keep an eye on your drivers' locations in real-time.</p>
            </div>
          </div>
          <div class="feature text-center">
            <div class="feature-inner">
              ...
              <h4 class="feature-title h3-mobile mb-8">Schedule Management</h4>
              <p class="text-sm">Easily organize and manage your drivers' schedules.</p>
            </div>
          </div>
          <div class="feature text-center">
            <div class="feature-inner">
              <div class="feature-icon" style="background:#C6FDF3;">
                <svg width="88" height="88" xmlns="http://www.w3.org/2000/svg">
                  <g fill="none" fill-rule="nonzero">
                    ...
                    <path d="M53 42h2v-8a1 1 0 0 0-1-1h-8v2h5.586l-8.293 8.293a1 1 0 1 0 1.414 1.414L53 36.414V42z"
                          fill="#1ADAB7"/>
                    <path fill="#83F0DD"
              ...
              <h4 class="feature-title h3-mobile mb-8">Route Optimization</h4>
              <p class="text-sm"> Use smart algorithms to find the best routes and save time.</p>
            </div>
          </div>
          <div class="feature text-center">
            <div class="feature-inner">
              ...
              <h4 class="feature-title h3-mobile mb-8">Worksheet Management</h4>
              <p class="text-sm">Manage and track your clients & worksheets and tasks efficiently.</p>
            </div>
          </div>
        </div>
      </div>
